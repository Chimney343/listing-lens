...
class OtodomSlugSpider(scrapy.Spider):
    ...
    def _write_slug_run_to_db(self, slug_run: SlugRunMetaItem) -> None:
        ...
        try:
            ...
            record = storage_db.build_slug_run_record(slug_run)
...
class OtodomDetailSpider(scrapy.Spider):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if slug_collection_file:
            ...
            inferred_city = self._read_city_from_slug_run_meta(slug_collection_file)
        elif slugs_file:
    ...
    @staticmethod
    def _read_city_from_slug_run_meta(path: str) -> str | None:
        """Read city from the sibling slug_run_meta.jsonl generated by OtodomSlugSpider."""
        meta_path = Path(path).with_name("slug_run_meta.jsonl")
